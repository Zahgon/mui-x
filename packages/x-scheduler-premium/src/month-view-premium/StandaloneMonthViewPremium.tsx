...
/**
 * Premium version of a Month View that can be used outside of the Event Calendar.
 */
const StandaloneMonthViewPremium = React.forwardRef(function StandaloneMonthViewPremium<
...
export { StandaloneMonthViewPremium };

interface StandaloneMonthViewPremiumComponent {
