...
/**
 * Premium version of a Day View that can be used outside of the Event Calendar.
 */
const StandaloneDayViewPremium = React.forwardRef(function StandaloneDayViewPremium<
  TEvent extends object,
  TResource extends object,
>(
  inProps: StandaloneDayViewPremiumProps<TEvent, TResource>,
  forwardedRef: React.ForwardedRef<HTMLDivElement>,
) {
    throw new Error("STUB");
}) as StandaloneDayViewPremiumComponent;

StandaloneDayViewPremium.propTypes /* remove-proptypes */ = {
  // ----------------------------- Warning --------------------------------
...
export { StandaloneDayViewPremium };

interface StandaloneDayViewPremiumComponent {
  <TEvent extends object, TResource extends object>(
    props: StandaloneDayViewPremiumProps<TEvent, TResource> & {
