...
/**
 * Premium version of an Agenda View that can be used outside of the Event Calendar.
 */
const StandaloneAgendaViewPremium = React.forwardRef(function StandaloneAgendaViewPremium<
...
export { StandaloneAgendaViewPremium };

interface StandaloneAgendaViewPremiumComponent {
